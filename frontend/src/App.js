...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OsJR9SDTj3mWS3jgsua6sqMqj0axjtVF6ENXSGcivgiddrXGlNy4oAAV4iYD867JRyVUWAbGbkqeNilW9wD9DZv00H9awWEiS"
  );
  ...
  //manages the routing config for the appplication
  const router = createBrowserRouter(
    //creates routes from the elements passes to it
    createRoutesFromElements(
      //defines a route component that matches all paths
