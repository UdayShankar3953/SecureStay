    ...
    <div className='property-container'>
        {
            ...
            <h6 className='property-location'><span className="material-symbols-outlined">house</span>
            <span className='location'>{`${address.area}, ${address.city} ${address.state} ${address.pincode}`}</span></h6>
            ...
            <div className='property-map'>
              <div className='map-image-exinfo-container row'>
                ...
                <div className='extra-info col-md-6 col-sm-12 col-12'>
                  <h2 className='extra-heading'>Extrta Info</h2>
